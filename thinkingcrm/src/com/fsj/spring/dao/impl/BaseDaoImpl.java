...
import com.fsj.spring.util.DataTableModel;
...
public class BaseDaoImpl extends HibernateDaoSupport implements BaseDao {
	...
	public List findByProperty(Class clazz, String propertyName, Object value) {
		...
		try {
			...
			log.error("find " + clazz.getSimpleName()
				...
				while (resultSet.next()) {
					...
					for (int i = 0; i < columnName.length; i++) {
						map.put(columnName[i],
								resultSet.getString(columnName[i]));
					}
					resultlist.add(map);
				}
	 ...
	 * 使用example查询分页
	 */
	public Map<String, Object> getPageListByExemple(DataGridModel dgm,
		...
		List pagelist = getHibernateTemplate().findByExample(instance,
				(dgm.getPage() - 1) * dgm.getRows(), dgm.getRows());
	...
	public Map<String, Object> getPageList(DataGridModel dgm,
			String countQuery, String resultQuery, Map<String, Object> params)
			throws Exception {
		Map<String, Object> result = new HashMap<String, Object>(2);
		String orderString = "";
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public Map<String, Object> getPageListBySQL(Map<String, Object> params,String countSQL, String resultSQL, Map<String, Object> queryParams) throws Exception {
		...
		if (queryParams != null && !queryParams.isEmpty()) {
			...
			while (it.hasNext()) {
				String key = it.next();
				queryTotal.setParameter(key, queryParams.get(key));
		...
		List list = queryList.list();
		result.put("sEcho", params.get("sEcho"));
