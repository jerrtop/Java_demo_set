...
<LINK href="<%=request.getContextPath() %>/css/User_Login.css" type=text/css rel=stylesheet>
				...
				<UL>
					...
					<LI class=user_main_c>
						<DIV class=user_main_box>
						  <form id="loginForm" method="post" action="<%=request.getContextPath() %>/welcome">
					...
					<LI class=user_main_r>
						...
						onclick='login()' type=image src="<%=request.getContextPath() %>/images/index/user_botton.gif" name=IbtnEnter>
					</LI>
				</UL>
			<DD id=user_bottom>
				<UL>
					...
					<LI class=user_bottom_c  style="text-align:center">
						<SPAN style="MARGIN-TOP: 40px" id="messageInfo">
							${message }
						</SPAN>
					</LI>
