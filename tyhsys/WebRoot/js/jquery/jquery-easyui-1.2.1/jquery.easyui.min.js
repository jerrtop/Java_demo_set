...
// 修复bug,1.checkbox radio不能选中 2.修正checkbox为多选的，注意checkbox为多选的时候json的键名称对应的值为数组[]，而不是字符串"1,3,4"这种
...
//alert(_37a.children("div.datagrid-header").find("table").width() + "&" + _37a.width());
...
// var rate=(_3c9.width()-_3c9.find("table").width()-18)/_3ca; // jerry
...
if(opts.height=="auto"){
//var _515=_513.find("div.datagrid-body table").height()+18; // jerry
var _515=_513.find("div.datagrid-body table").height();
